# -*- coding: utf-8 -*-
#
# classylss documentation build configuration file, created by
...
# further.  For a list of options available for each theme, see the
# documentation.
#html_logo = '_static/classylss-logo-white.png'
# html_theme_options = {
#     'logo_only': True,
...
htmlhelp_basename = 'classylssdoc'
...
latex_documents = [
  (master_doc, 'classylss.tex', u'classylss Documentation',
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'classylss', u'classylss Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'classylss', u'classylss Documentation',
   author, 'classylss', 'One line description of project.',
   'Miscellaneous'),
]
