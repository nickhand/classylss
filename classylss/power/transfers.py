...
class CLASS(object):
    ...
    def __call__(self, k):
        r"""
        Return the CLASS linear transfer function at :attr:`z`. This
        ...
        """
        k = np.asarray(k)
        linearP = self.cosmo.get_pklin(k, self.z) / self.cosmo.h**3 # in Mpc^3
...
class EisensteinHu(object):
    ...
    def __call__(self, k):
        ...
        return T * self.cosmo.scale_independent_growth_factor(self.z)
